...
```ts
import { useAddMovieToList, useGetPublicLists, useCreateUser, useGetMoviesByGenre } from '@dataconnect/generated/react';
...
```js
import { addMovieToList, getPublicLists, createUser, getMoviesByGenre } from '@dataconnect/generated';
